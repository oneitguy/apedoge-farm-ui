...
const PoolCard: React.FC<HarvestProps> = ({
  ...
  const max = sousId === 10 ? (stakedBalance.gt(syrupBalance) ? syrupBalance : stakedBalance) : stakedBalance
  ...
  return (
    <Card isActive={isCardActive} isFinished={isReallyFinished && sousId !== 40}>
